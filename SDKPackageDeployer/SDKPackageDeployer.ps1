...
$DestinationDirectory = "$(BUILD.SOURCESDIRECTORY)\SDKPackageDeployer\"
$NuSpecPath = ($DestinationDirectory + "SDKPackageDeployer.nuspec")
...
# push "$(BUILD.SOURCESDIRECTORY)\SDKPackageDeployer\*.nupkg" -ApiKey "$(PackagesReadWrite)" -Source "$(FeedUrl)"
...
#$NuSpecPath = "$(BUILD.SOURCESDIRECTORY)\SDKPackageDeployer\SDKPackageDeployer.nuspec"
#
