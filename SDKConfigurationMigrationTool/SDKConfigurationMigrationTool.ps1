...
$PackageName = "Microsoft.CrmSdk.XrmTooling.ConfigurationMigration.Wpf"
# Substitute the working folder and .nuspec file names
$DestinationDirectory = "$(BUILD.SOURCESDIRECTORY)\SDKConfigurationMigrationTool\"
$NuSpecPath = ($DestinationDirectory + "SDKConfigurationMigrationTool.nuspec")
...
# push "$(BUILD.SOURCESDIRECTORY)\SDKConfigurationMigrationTool\*.nupkg" -ApiKey "$(PackagesReadWrite)" -Source "$(FeedUrl)"
...
#$NuSpecPath = "$(BUILD.SOURCESDIRECTORY)\SDKConfigurationMigrationTool\SDKConfigurationMigrationTool.nuspec"
#
